    ...
    <Form onSubmit={handleSubmit(onSubmit)}>
      ...
      <Form.Body>
        <div className="flex flex-col gap-1.5">
          <label htmlFor="lastname" className="text-sm font-medium"><T dict={trad}>lastname</T></label>
        ...
        <div className="flex flex-col gap-1.5">
          <label htmlFor="firstname" className="text-sm font-medium"><T dict={trad}>firstname</T></label>
        ...
        <div className="flex flex-col gap-1.5">
          <label htmlFor="password" className="text-sm font-medium"><T dict={trad}>password</T></label>
        ...
        <div className="flex flex-col gap-1.5">
          <label htmlFor="password_confirmation" className="text-sm font-medium"><T dict={trad}>password_confirmation</T></label>
